 ...
 */
export const getSalesPerMonthWidgetData = <ThrowOnError extends boolean = false>(options: Options<GetSalesPerMonthWidgetDataData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<GetSalesPerMonthWidgetDataResponses, GetSalesPerMonthWidgetDataErrors, ThrowOnError>({
        responseType: 'json',
