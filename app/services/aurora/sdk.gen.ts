 ...
 */
export const getOrderWidgetsData = <ThrowOnError extends boolean = false>(options: Options<GetOrderWidgetsDataData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<GetOrderWidgetsDataResponses, GetOrderWidgetsDataErrors, ThrowOnError>({
        responseType: 'json',
