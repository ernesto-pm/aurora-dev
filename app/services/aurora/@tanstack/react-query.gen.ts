 ...
 */
export const editAssociatedProductsMutation = (options?: Partial<Options<EditAssociatedProductsData>>): UseMutationOptions<unknown, AxiosError<EditAssociatedProductsError>, Options<EditAssociatedProductsData>> => {
    const mutationOptions: UseMutationOptions<unknown, AxiosError<EditAssociatedProductsError>, Options<EditAssociatedProductsData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await editAssociatedProducts({
                ...options,
                ...localOptions,
                throwOnError: true
            });
