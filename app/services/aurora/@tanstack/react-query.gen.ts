...
export const getOrderWidgetsDataQueryKey = (options: Options<GetOrderWidgetsDataData>) => createQueryKey('getOrderWidgetsData', options);

/**
 * Get Order Widgets Data
 */
export const getOrderWidgetsDataOptions = (options: Options<GetOrderWidgetsDataData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getOrderWidgetsData({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getOrderWidgetsDataQueryKey(options)
    });
};
 ...
 * Get Order Widgets Data
 */
export const getOrderWidgetsDataMutation = (options?: Partial<Options<GetOrderWidgetsDataData>>): UseMutationOptions<unknown, AxiosError<GetOrderWidgetsDataError>, Options<GetOrderWidgetsDataData>> => {
    const mutationOptions: UseMutationOptions<unknown, AxiosError<GetOrderWidgetsDataError>, Options<GetOrderWidgetsDataData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await getOrderWidgetsData({
                ...options,
                ...localOptions,
