 ...
 * Get Businesses For Supabase User
 */
export const getBusinessesForSupabaseUserMutation = (options?: Partial<Options<GetBusinessesForSupabaseUserData>>): UseMutationOptions<unknown, AxiosError<DefaultError>, Options<GetBusinessesForSupabaseUserData>> => {
    const mutationOptions: UseMutationOptions<unknown, AxiosError<DefaultError>, Options<GetBusinessesForSupabaseUserData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await getBusinessesForSupabaseUser({
                ...options,
                ...localOptions,
