 ...
 */
export const getAllOrderSummaries = <ThrowOnError extends boolean = false>(options?: Options<GetAllOrderSummariesData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetAllOrderSummariesResponses, unknown, ThrowOnError>({
        responseType: 'json',
...
/**
 * Create New Basket Order Summary
 */
export const createNewBasketOrderSummary = <ThrowOnError extends boolean = false>(options: Options<CreateNewBasketOrderSummaryData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).post<CreateNewBasketOrderSummaryResponses, CreateNewBasketOrderSummaryErrors, ThrowOnError>({
        responseType: 'json',
        url: '/ma_basket/order-summary',
        ...options,
        headers: {
...
/**
 * Refresh Ma Basket Summary
 */
export const refreshMaBasketSummary = <ThrowOnError extends boolean = false>(options: Options<RefreshMaBasketSummaryData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<RefreshMaBasketSummaryResponses, RefreshMaBasketSummaryErrors, ThrowOnError>({
        responseType: 'json',
...
/**
 * Delete Basket Summary With Id
 */
export const deleteBasketSummaryWithId = <ThrowOnError extends boolean = false>(options: Options<DeleteBasketSummaryWithIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).delete<DeleteBasketSummaryWithIdResponses, DeleteBasketSummaryWithIdErrors, ThrowOnError>({
        responseType: 'json',
...
/**
 * Get Order Summary With Id
 */
export const getOrderSummaryWithId = <ThrowOnError extends boolean = false>(options: Options<GetOrderSummaryWithIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetOrderSummaryWithIdResponses, GetOrderSummaryWithIdErrors, ThrowOnError>({
        responseType: 'json',
