...
export const getRevenueConcentrationQueryKey = (options: Options<GetRevenueConcentrationData>) => createQueryKey('getRevenueConcentration', options);

/**
 * Get Revenue Concentration
 */
export const getRevenueConcentrationOptions = (options: Options<GetRevenueConcentrationData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
        ...
        queryKey: getRevenueConcentrationQueryKey(options)
    });
};
 ...
 * Get Revenue Concentration
 */
export const getRevenueConcentrationMutation = (options?: Partial<Options<GetRevenueConcentrationData>>): UseMutationOptions<GetRevenueConcentrationResponse2, AxiosError<GetRevenueConcentrationError>, Options<GetRevenueConcentrationData>> => {
    const mutationOptions: UseMutationOptions<GetRevenueConcentrationResponse2, AxiosError<GetRevenueConcentrationError>, Options<GetRevenueConcentrationData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await getRevenueConcentration({
                ...options,
                ...localOptions,
...
export const getOrderVelocityQueryKey = (options: Options<GetOrderVelocityData>) => createQueryKey('getOrderVelocity', options);

/**
 * Get Order Velocity
 */
export const getOrderVelocityOptions = (options: Options<GetOrderVelocityData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getOrderVelocity({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getOrderVelocityQueryKey(options)
    });
};
 ...
 * Get Order Velocity
 */
export const getOrderVelocityMutation = (options?: Partial<Options<GetOrderVelocityData>>): UseMutationOptions<GetOrderVelocityResponse2, AxiosError<GetOrderVelocityError>, Options<GetOrderVelocityData>> => {
    const mutationOptions: UseMutationOptions<GetOrderVelocityResponse2, AxiosError<GetOrderVelocityError>, Options<GetOrderVelocityData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await getOrderVelocity({
                ...options,
                ...localOptions,
...
export const updateDashboardLayoutQueryKey = (options: Options<UpdateDashboardLayoutData>) => createQueryKey('updateDashboardLayout', options);

/**
 * Update Dashboard Layout
 */
export const updateDashboardLayoutOptions = (options: Options<UpdateDashboardLayoutData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
        ...
        queryKey: updateDashboardLayoutQueryKey(options)
    });
};
 ...
 * Update Dashboard Layout
 */
export const updateDashboardLayoutMutation = (options?: Partial<Options<UpdateDashboardLayoutData>>): UseMutationOptions<UpdateDashboardLayoutResponse, AxiosError<UpdateDashboardLayoutError>, Options<UpdateDashboardLayoutData>> => {
    const mutationOptions: UseMutationOptions<UpdateDashboardLayoutResponse, AxiosError<UpdateDashboardLayoutError>, Options<UpdateDashboardLayoutData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await updateDashboardLayout({
                ...options,
                ...localOptions,
...
export const getAllCustomAppsForSupabaseUserQueryKey = (options?: Options<GetAllCustomAppsForSupabaseUserData>) => createQueryKey('getAllCustomAppsForSupabaseUser', options);

/**
 * Get All Custom Apps For Supabase User
 */
export const getAllCustomAppsForSupabaseUserOptions = (options?: Options<GetAllCustomAppsForSupabaseUserData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
        ...
        queryKey: getAllCustomAppsForSupabaseUserQueryKey(options)
    });
};

export const upsertWidgetAssistanceChatQueryKey = (options: Options<UpsertWidgetAssistanceChatData>) => createQueryKey('upsertWidgetAssistanceChat', options);

/**
 * Upsert Widget Assistance Chat
 */
export const upsertWidgetAssistanceChatOptions = (options: Options<UpsertWidgetAssistanceChatData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
        ...
        queryKey: upsertWidgetAssistanceChatQueryKey(options)
    });
};
 ...
 * Upsert Widget Assistance Chat
 */
export const upsertWidgetAssistanceChatMutation = (options?: Partial<Options<UpsertWidgetAssistanceChatData>>): UseMutationOptions<UpsertWidgetAssistanceChatResponse, AxiosError<UpsertWidgetAssistanceChatError>, Options<UpsertWidgetAssistanceChatData>> => {
    const mutationOptions: UseMutationOptions<UpsertWidgetAssistanceChatResponse, AxiosError<UpsertWidgetAssistanceChatError>, Options<UpsertWidgetAssistanceChatData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await upsertWidgetAssistanceChat({
                ...options,
                ...localOptions,
...
export const getWidgetAssistanceChatWithIdQueryKey = (options: Options<GetWidgetAssistanceChatWithIdData>) => createQueryKey('getWidgetAssistanceChatWithId', options);

/**
 * Get Widget Assistance Chat With Id
 */
export const getWidgetAssistanceChatWithIdOptions = (options: Options<GetWidgetAssistanceChatWithIdData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getWidgetAssistanceChatWithId({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getWidgetAssistanceChatWithIdQueryKey(options)
    });
};

export const insertUserMessageIntoWidgetAssistantChatQueryKey = (options: Options<InsertUserMessageIntoWidgetAssistantChatData>) => createQueryKey('insertUserMessageIntoWidgetAssistantChat', options);

/**
 * Insert User Message Into Widget Assistant Chat
 */
export const insertUserMessageIntoWidgetAssistantChatOptions = (options: Options<InsertUserMessageIntoWidgetAssistantChatData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await insertUserMessageIntoWidgetAssistantChat({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: insertUserMessageIntoWidgetAssistantChatQueryKey(options)
    });
};
 ...
 * Insert User Message Into Widget Assistant Chat
 */
export const insertUserMessageIntoWidgetAssistantChatMutation = (options?: Partial<Options<InsertUserMessageIntoWidgetAssistantChatData>>): UseMutationOptions<InsertUserMessageIntoWidgetAssistantChatResponse, AxiosError<InsertUserMessageIntoWidgetAssistantChatError>, Options<InsertUserMessageIntoWidgetAssistantChatData>> => {
    const mutationOptions: UseMutationOptions<InsertUserMessageIntoWidgetAssistantChatResponse, AxiosError<InsertUserMessageIntoWidgetAssistantChatError>, Options<InsertUserMessageIntoWidgetAssistantChatData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await insertUserMessageIntoWidgetAssistantChat({
                ...options,
                ...localOptions,
...
export const getAllMessagesForWidgetAssistanceChatWithIdQueryKey = (options: Options<GetAllMessagesForWidgetAssistanceChatWithIdData>) => createQueryKey('getAllMessagesForWidgetAssistanceChatWithId', options);

/**
 * Get All Messages For Widget Assistance Chat With Id
 */
export const getAllMessagesForWidgetAssistanceChatWithIdOptions = (options: Options<GetAllMessagesForWidgetAssistanceChatWithIdData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getAllMessagesForWidgetAssistanceChatWithId({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getAllMessagesForWidgetAssistanceChatWithIdQueryKey(options)
    });
};

export const triggerAssistantResponseForWidgetAssistanceChatQueryKey = (options: Options<TriggerAssistantResponseForWidgetAssistanceChatData>) => createQueryKey('triggerAssistantResponseForWidgetAssistanceChat', options);

/**
 * Trigger Assistant Response For Widget Assistance Chat
 */
export const triggerAssistantResponseForWidgetAssistanceChatOptions = (options: Options<TriggerAssistantResponseForWidgetAssistanceChatData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await triggerAssistantResponseForWidgetAssistanceChat({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: triggerAssistantResponseForWidgetAssistanceChatQueryKey(options)
    });
};
 ...
 * Trigger Assistant Response For Widget Assistance Chat
 */
export const triggerAssistantResponseForWidgetAssistanceChatMutation = (options?: Partial<Options<TriggerAssistantResponseForWidgetAssistanceChatData>>): UseMutationOptions<TriggerAssistantResponseForWidgetAssistanceChatResponse, AxiosError<TriggerAssistantResponseForWidgetAssistanceChatError>, Options<TriggerAssistantResponseForWidgetAssistanceChatData>> => {
    const mutationOptions: UseMutationOptions<TriggerAssistantResponseForWidgetAssistanceChatResponse, AxiosError<TriggerAssistantResponseForWidgetAssistanceChatError>, Options<TriggerAssistantResponseForWidgetAssistanceChatData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await triggerAssistantResponseForWidgetAssistanceChat({
                ...options,
                ...localOptions,
...
export const createLettaGeneralAssistantQueryKey = (options: Options<CreateLettaGeneralAssistantData>) => createQueryKey('createLettaGeneralAssistant', options);

/**
 * Create Letta General Assistant
 */
export const createLettaGeneralAssistantOptions = (options: Options<CreateLettaGeneralAssistantData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await createLettaGeneralAssistant({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: createLettaGeneralAssistantQueryKey(options)
    });
};
 ...
 * Create Letta General Assistant
 */
export const createLettaGeneralAssistantMutation = (options?: Partial<Options<CreateLettaGeneralAssistantData>>): UseMutationOptions<CreateLettaGeneralAssistantResponse, AxiosError<CreateLettaGeneralAssistantError>, Options<CreateLettaGeneralAssistantData>> => {
    const mutationOptions: UseMutationOptions<CreateLettaGeneralAssistantResponse, AxiosError<CreateLettaGeneralAssistantError>, Options<CreateLettaGeneralAssistantData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await createLettaGeneralAssistant({
                ...options,
                ...localOptions,
...
export const getGlobalBlocksForBusinessIdQueryKey = (options: Options<GetGlobalBlocksForBusinessIdData>) => createQueryKey('getGlobalBlocksForBusinessId', options);

/**
 * Get Global Blocks For Business Id
 */
export const getGlobalBlocksForBusinessIdOptions = (options: Options<GetGlobalBlocksForBusinessIdData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getGlobalBlocksForBusinessId({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getGlobalBlocksForBusinessIdQueryKey(options)
    });
};
 ...
 * Get Global Blocks For Business Id
 */
export const getGlobalBlocksForBusinessIdMutation = (options?: Partial<Options<GetGlobalBlocksForBusinessIdData>>): UseMutationOptions<GetGlobalBlocksForBusinessIdResponse2, AxiosError<GetGlobalBlocksForBusinessIdError>, Options<GetGlobalBlocksForBusinessIdData>> => {
    const mutationOptions: UseMutationOptions<GetGlobalBlocksForBusinessIdResponse2, AxiosError<GetGlobalBlocksForBusinessIdError>, Options<GetGlobalBlocksForBusinessIdData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await getGlobalBlocksForBusinessId({
                ...options,
                ...localOptions,
...
export const getBasketWithIdQueryKey = (options: Options<GetBasketWithIdData>) => createQueryKey('getBasketWithId', options);

/**
 * Get Basket With Id
 */
export const getBasketWithIdOptions = (options: Options<GetBasketWithIdData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getBasketWithId({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getBasketWithIdQueryKey(options)
    });
};

export const getAllBasketsQueryKey = (options?: Options<GetAllBasketsData>) => createQueryKey('getAllBaskets', options);

/**
 * Get All Baskets
 */
export const getAllBasketsOptions = (options?: Options<GetAllBasketsData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
        ...
        queryKey: getAllBasketsQueryKey(options)
    });
};

export const createBasketQueryKey = (options: Options<CreateBasketData>) => createQueryKey('createBasket', options);

/**
 * Create Basket
 */
export const createBasketOptions = (options: Options<CreateBasketData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
        ...
        queryKey: createBasketQueryKey(options)
    });
};
 ...
 * Create Basket
 */
export const createBasketMutation = (options?: Partial<Options<CreateBasketData>>): UseMutationOptions<CreateBasketResponse, AxiosError<CreateBasketError>, Options<CreateBasketData>> => {
    const mutationOptions: UseMutationOptions<CreateBasketResponse, AxiosError<CreateBasketError>, Options<CreateBasketData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await createBasket({
                ...options,
                ...localOptions,
 ...
 */
export const updateAssociatedProductsMutation = (options?: Partial<Options<UpdateAssociatedProductsData>>): UseMutationOptions<unknown, AxiosError<UpdateAssociatedProductsError>, Options<UpdateAssociatedProductsData>> => {
    const mutationOptions: UseMutationOptions<unknown, AxiosError<UpdateAssociatedProductsError>, Options<UpdateAssociatedProductsData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await updateAssociatedProducts({
                ...options,
                ...localOptions,
                throwOnError: true
            });
...
export const getAllOrderSummariesQueryKey = (options?: Options<GetAllOrderSummariesData>) => createQueryKey('getAllOrderSummaries', options);

/**
 * Get All Order Summaries
 */
export const getAllOrderSummariesOptions = (options?: Options<GetAllOrderSummariesData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getAllOrderSummaries({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getAllOrderSummariesQueryKey(options)
    });
};

export const createNewBasketOrderSummaryQueryKey = (options: Options<CreateNewBasketOrderSummaryData>) => createQueryKey('createNewBasketOrderSummary', options);

/**
 * Create New Basket Order Summary
 */
export const createNewBasketOrderSummaryOptions = (options: Options<CreateNewBasketOrderSummaryData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await createNewBasketOrderSummary({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: createNewBasketOrderSummaryQueryKey(options)
    });
};
 ...
 * Create New Basket Order Summary
 */
export const createNewBasketOrderSummaryMutation = (options?: Partial<Options<CreateNewBasketOrderSummaryData>>): UseMutationOptions<unknown, AxiosError<CreateNewBasketOrderSummaryError>, Options<CreateNewBasketOrderSummaryData>> => {
    const mutationOptions: UseMutationOptions<unknown, AxiosError<CreateNewBasketOrderSummaryError>, Options<CreateNewBasketOrderSummaryData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await createNewBasketOrderSummary({
                ...options,
                ...localOptions,
...
export const refreshMaBasketSummaryQueryKey = (options: Options<RefreshMaBasketSummaryData>) => createQueryKey('refreshMaBasketSummary', options);

/**
 * Refresh Ma Basket Summary
 */
export const refreshMaBasketSummaryOptions = (options: Options<RefreshMaBasketSummaryData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await refreshMaBasketSummary({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: refreshMaBasketSummaryQueryKey(options)
    });
};
 ...
 */
export const deleteBasketSummaryWithIdMutation = (options?: Partial<Options<DeleteBasketSummaryWithIdData>>): UseMutationOptions<unknown, AxiosError<DeleteBasketSummaryWithIdError>, Options<DeleteBasketSummaryWithIdData>> => {
    const mutationOptions: UseMutationOptions<unknown, AxiosError<DeleteBasketSummaryWithIdError>, Options<DeleteBasketSummaryWithIdData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await deleteBasketSummaryWithId({
                ...options,
                ...localOptions,
                throwOnError: true
            });
...
export const getOrderSummaryWithIdQueryKey = (options: Options<GetOrderSummaryWithIdData>) => createQueryKey('getOrderSummaryWithId', options);

/**
 * Get Order Summary With Id
 */
export const getOrderSummaryWithIdOptions = (options: Options<GetOrderSummaryWithIdData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
        ...
        queryKey: getOrderSummaryWithIdQueryKey(options)
    });
};

export const getShopifyProductsQueryKey = (options: Options<GetShopifyProductsData>) => createQueryKey('getShopifyProducts', options);

/**
 * Get Shopify Products
 */
export const getShopifyProductsOptions = (options: Options<GetShopifyProductsData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
        ...
        queryKey: getShopifyProductsQueryKey(options)
    });
};
 ...
 * Get Shopify Products
 */
export const getShopifyProductsMutation = (options?: Partial<Options<GetShopifyProductsData>>): UseMutationOptions<GetShopifyProductsResponse, AxiosError<GetShopifyProductsError>, Options<GetShopifyProductsData>> => {
    const mutationOptions: UseMutationOptions<GetShopifyProductsResponse, AxiosError<GetShopifyProductsError>, Options<GetShopifyProductsData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await getShopifyProducts({
                ...options,
                ...localOptions,
...
export const syncAllProductsQueryKey = (options?: Options<SyncAllProductsData>) => createQueryKey('syncAllProducts', options);

/**
 * Sync All Products
 */
export const syncAllProductsOptions = (options?: Options<SyncAllProductsData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await syncAllProducts({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: syncAllProductsQueryKey(options)
    });
};
 ...
 * Sync All Products
 */
export const syncAllProductsMutation = (options?: Partial<Options<SyncAllProductsData>>): UseMutationOptions<SyncAllProductsResponse, AxiosError<DefaultError>, Options<SyncAllProductsData>> => {
    const mutationOptions: UseMutationOptions<SyncAllProductsResponse, AxiosError<DefaultError>, Options<SyncAllProductsData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await syncAllProducts({
                ...options,
                ...localOptions,
...
export const getMaProductsDumpsQueryKey = (options?: Options<GetMaProductsDumpsData>) => createQueryKey('getMaProductsDumps', options);

/**
 * Get Ma Products Dumps
 */
export const getMaProductsDumpsOptions = (options?: Options<GetMaProductsDumpsData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getMaProductsDumps({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getMaProductsDumpsQueryKey(options)
    });
};