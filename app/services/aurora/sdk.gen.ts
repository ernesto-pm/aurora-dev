 ...
 */
export const editAssociatedProducts = <ThrowOnError extends boolean = false>(options: Options<EditAssociatedProductsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).put<EditAssociatedProductsResponses, EditAssociatedProductsErrors, ThrowOnError>({
        responseType: 'json',
