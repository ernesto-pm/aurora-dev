...
export const getSalesPerMonthWidgetDataQueryKey = (options: Options<GetSalesPerMonthWidgetDataData>) => createQueryKey('getSalesPerMonthWidgetData', options);

/**
 * Get Sales Per Month Widget Data
 */
export const getSalesPerMonthWidgetDataOptions = (options: Options<GetSalesPerMonthWidgetDataData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
            const { data } = await getSalesPerMonthWidgetData({
                ...options,
                ...queryKey[0],
                signal,
                throwOnError: true
        ...
        queryKey: getSalesPerMonthWidgetDataQueryKey(options)
    });
};
 ...
 * Get Sales Per Month Widget Data
 */
export const getSalesPerMonthWidgetDataMutation = (options?: Partial<Options<GetSalesPerMonthWidgetDataData>>): UseMutationOptions<GetSalesPerMonthWidgetDataResponse2, AxiosError<GetSalesPerMonthWidgetDataError>, Options<GetSalesPerMonthWidgetDataData>> => {
    const mutationOptions: UseMutationOptions<GetSalesPerMonthWidgetDataResponse2, AxiosError<GetSalesPerMonthWidgetDataError>, Options<GetSalesPerMonthWidgetDataData>> = {
        mutationFn: async (localOptions) => {
            const { data } = await getSalesPerMonthWidgetData({
                ...options,
                ...localOptions,
